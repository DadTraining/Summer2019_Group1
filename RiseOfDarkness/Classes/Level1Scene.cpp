...
void Level1Scene::AddListener()
{
	...
	m_buttons[9]->addClickEventListener([&](Ref* event) {
		MainCharacter::GetInstance()->GetInventory()->RemoveItem(0, MainCharacter::GetInstance()->GetInventory()->GetIdByIcon(0));
	});

	m_buttons[10]->addClickEventListener([&](Ref* event) {
		MainCharacter::GetInstance()->GetInventory()->RemoveItem(1, MainCharacter::GetInstance()->GetInventory()->GetIdByIcon(1));
	});
